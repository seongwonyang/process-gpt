                ...
                <v-table>
                    ...
                    <tbody>
                        <tr v-for="(val, idx) in value" :key="val" @click="changeSelectedRow(val)" :style="val === selectedRow ? 'background-color: #f0f3ff;':''">
                            ...
                            <td class="whitespace-nowrap" label="계정 이름">{{ val.accountName }}</td>
                            <td class="whitespace-nowrap" label="대표자">{{ val.representative }}</td>
                            <td class="whitespace-nowrap" label="주소">
                                <Address :editMode="false" :inList="true" v-model="val.address"></Address>
                            </td>
                            <td class="whitespace-nowrap" label="업종">{{ val.industry }}</td>
                            <td class="whitespace-nowrap" label="종목">{{ val.category }}</td>
                            <td class="whitespace-nowrap" label="거래처 구분">{{ val.customerType }}</td>
