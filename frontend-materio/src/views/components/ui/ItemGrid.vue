                ...
                <v-table>
                    ...
                    <tbody>
                        <tr v-for="(val, idx) in value" :key="val" @click="changeSelectedRow(val)" :style="val === selectedRow ? 'background-color: #f0f3ff;':''">
                            ...
                            <td class="whitespace-nowrap" label="품명">{{ val.itemName }}</td>
                            <td class="whitespace-nowrap" label="코드">{{ val.itemCode }}</td>
                            <td class="whitespace-nowrap" label="단위">{{ val.itemUnit }}</td>
